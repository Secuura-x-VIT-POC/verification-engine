...
- Gemini integration, when enabled, uses bounded structured outputs across graph nodes.
- Gemini failures must degrade to deterministic outputs without breaking the workflow.
