...
class Session(Base):
    ...
    provider_operating_mode = Column(String, nullable=True)
    demo_profile_key = Column(String, nullable=True)
    execution_environment_label = Column(String, nullable=True)
    provider_transition_notes = Column(JSON, nullable=True)
