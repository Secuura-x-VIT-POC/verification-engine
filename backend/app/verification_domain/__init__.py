...
_LAZY_IMPORTS = {
    ...
    "build_and_persist_final_analysis": (".service", "build_and_persist_final_analysis"),
    "build_and_persist_initial_analysis": (".service", "build_and_persist_initial_analysis"),
